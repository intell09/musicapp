...
//  musicapp
//
//  Created by russell gadsden on 6/19/23.
//
...
class PlayerViewController: UIViewController {
    ...
    func configure() {
        ...
        slider.value = 0.5
        slider.addTarget(self, action: #selector(didSlidesSlider(_:)), for: .valueChanged)
    ...
    @objc func didSlidesSlider(_ slider: UISlider) {
